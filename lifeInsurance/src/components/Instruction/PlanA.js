    ...
    return (
      <div>
        <div >
            ...
            <DatePicker
              mode="date"
              value={this.props.insurantBirthday?moment(this.props.insurantBirthday):moment().subtract(1, "months") }
              extra={"请选择"}
            ...
            <Picker
                ...
                onOk={v => this.props.onChangeBuyNum(v)}
              >
            ...
            <Picker
                ...
                onOk={v => this.props.onChangePayMent(v)}
              >
