        ...
        <ul className={style.feature}>
            <li>
                ...
                <div  className={style.content_img}>
                     <img src={require('../asset/img/anxinli/1_03.jpg')}/>
        	 ...
        	 <li>
              <h2 className={style.feature_2}>02 灵活便捷</h2>
                <div  className={style.content_img}>
                     <img src={require('../asset/img/anxinli/2_06.jpg')}/>
             ...
             <li>
              <h2 className={style.feature_3}>03 两全保障 攻守兼备</h2>
                <div  className={style.content_img}>
                     <img src={require('../asset/img/anxinli/3_08.jpg')}/>
                      <p className={`${style.p_right} `}>
                       每年收取风险保证金<br/>
                       满期后获得等同于<br/>
                       账户价值的保险金
             ...
             <h2 className={style.feature_4}>04 持续奖励 受益添彩</h2>
                <div  className={style.content_img}>
                     <img src={require('../asset/img/anxinli/4_11.jpg')}/>
                      <p className={style.p_left}>
                       第五个保单年度末将<br/>
                       获得1%保单账户<br/>
                       价值的持续奖金
            ...
            <li>
             <h2 className={style.feature_5}>05日日复利 月月结息</h2>
                <div  className={style.content_img}>
                     <img src={require('../asset/img/anxinli/5_14.jpg')}/>
                     <p className={style.p_right}>
                       彰显复利优势<br/>
                       应对通胀压力 
                     </p>
